    ...
    <div className="hero mt-14">
      <div className="hero-content flex-col gap-10 lg:flex-row">
        ...
        <div data-aos="fade-up" className="">
          <h1 className=" mt-4 text-5xl font-bold text-accent">Job Market</h1>
          <p className="py-6">
          ...
          <div className="flex gap-3 mt-3 flex-wrap">
            <a
              href="https://github.com/zannat20040/Worky-job-market"
              target="_blank"
            >
            ...
            <a
              href="https://github.com/zannat20040/Worky-server"
              target="_blank"
            >
              <button className="border btn  py-4 px-16 bg-slate-950 text-white  rounded-md ">
                Server code
